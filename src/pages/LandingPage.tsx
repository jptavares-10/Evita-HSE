...
const faqs = [
  ...
  { q: "Existe software para controle de EPI gratuito?", a: "O Evita HSE oferece 7 dias de teste grátis com acesso completo, incluindo gestão de EPIs com catálogo, controle de estoque, entregas e alertas de CA. Após o trial, planos a partir de R$ 97/mês." },
