...
const pricingPlans = [
  {
    ...
    priceMonthly: "R$ 129",
    priceAnnual: "R$ 1.290",
    savingsAnnual: "Economize R$ 258",
    features: ["Serviços Periódicos", "Treinamentos com matriz por cargo", "ASO", "IC & NC (registro)", "Documentos", "5 usuários", "5GB storage"],
    featured: false,
  },
  {
    key: "professional",
    ...
    priceMonthly: "R$ 349",
    priceAnnual: "R$ 3.490",
    savingsAnnual: "Economize R$ 698",
    features: ["Tudo do Starter", "EPI com assinatura digital", "Inspeções de campo com foto", "MTR", "Licenças Ambientais", "Calendário unificado", "5 Porquês", "15 usuários", "20GB"],
    featured: true,
  },
  {
    key: "enterprise",
    ...
    priceMonthly: "R$ 749",
    priceAnnual: "R$ 7.490",
    savingsAnnual: "Economize R$ 1.498",
    features: ["Tudo do Professional", "Ishikawa e Bow-Tie", "Condicionantes com evidência", "Portal de fornecedores", "Ciclo de revisão de documentos", "Integração de agentes (MCP)", "Usuários ilimitados", "100GB", "SLA 24h"],
    featured: false,
  },
];
...
export default function LandingPage() {
  ...
  usePageTitle("Evita HSE — Software de Gestão de SST, Saúde e Meio Ambiente", {
    description: "Software de SST, Saúde e Meio Ambiente. Controle EPIs, treinamentos NR, inspeções, MTR, licenças e ASO com alertas automáticos. Teste 14 dias grátis.",
  });
