...
export function BlogCTA() {
  return (
    <aside className="lp-card lp-ring-gradient mt-16 rounded-2xl p-8 lg:p-10">
      <div className="flex items-start gap-4">
        <div className="hidden sm:flex w-12 h-12 rounded-xl bg-lp-emerald/10 border border-lp-emerald/25 items-center justify-center shrink-0">
          <ShieldCheck className="w-6 h-6 text-lp-emerald-glow" />
        </div>
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              to="/cadastro"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-lg bg-lp-emerald text-lp-bg font-medium hover:bg-lp-emerald-glow transition-colors lp-glow"
            >
