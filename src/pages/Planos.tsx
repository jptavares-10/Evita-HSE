...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "EPIs com assinatura digital e ficha NR-6",
      "Inspeções de campo com foto e geolocalização",
      "MTR / Resíduos",
      "Licenças Ambientais",
      "Calendário unificado de prazos",
      "Investigação por 5 Porquês",
  ...
  },
  {
    ...
    features: [
      ...
      "Ishikawa e Bow-Tie na investigação",
      "Condicionantes de licença com evidências",
      "Fornecedores com portal externo",
      "Ciclo de revisão e aprovação de documentos",
      "Integração de agentes (MCP) / API",
      "Usuários ilimitados",
      "Suporte SLA 24h",
