    ...
    <section className="py-24 px-6 lg:px-8 border-t border-lp-border">
      <div className="max-w-6xl mx-auto">
        <Reveal className="text-center mb-14">
          <p className="text-xs uppercase tracking-[0.2em] text-lp-emerald font-medium mb-3">Funcionalidades</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((f, i) => (
            <Reveal key={f.title} delay={i * 0.05}>
              <div className="lp-card rounded-2xl p-6 h-full transition-all">
